    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-sm-6 col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i class="iconly-Home icli svg-color"></i></a>
                        </li>
            ...
            <div class="col-xl-4 proorder-xxl-1 col-sm-6 box-col-6">
                <div class="card welcome-banner">
                    <div class="card-header p-0 card-no-border">
                        <div class="welcome-card"><img class="w-100 img-fluid" src="images/welcome-bg.png"
                                alt=""><img class="position-absolute img-1 img-fluid" src="images/img-1.png"
                                alt=""><img class="position-absolute img-2 img-fluid" src="images/img-2.png"
                                alt="">
                            <img class="position-absolute img-3 img-fluid" src="images/img-3.png" alt=""><img
                                class="position-absolute img-4 img-fluid" src="images/img-4.png" alt=""><img
                                class="position-absolute img-5 img-fluid" src="images/img-5.png" alt="">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="d-flex align-center">
                            <h1>Hello, {{Auth::user()->full_name}} <img src="images/hand.png" alt=""></h1>
                        </div>
                        ...
                        <div class="d-flex align-center justify-content-between"><a class="btn btn-pill btn-primary"
                                ...
                                <svg class="stroke-icon">
                                    <use href="images/icon-sprite.svg#watch"></use>
                        ...
                        <div class="d-flex align-center gap-3">
                            <h2>$4,875</h2><span class="text-primary">
                                ...
                                <svg class="stroke-icon stroke-primary">
                                    <use href="images/icon-sprite.svg#arrow-down"></use>
                                </svg></span>
                        </div>
                            ...
                            <li>
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 bg-light-primary">
                                        <svg class="stroke-icon">
                                            <use href="images/icon-sprite.svg#job-bag"></use>
                                        </svg>
                                    </div>
                            ...
                            <li>
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 bg-light-secondary">
                                        <svg class="stroke-icon">
                                            <use href="images/icon-sprite.svg#employees"></use>
                                        </svg>
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3>30</h3>
                            ...
                            <li>
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 bg-light-warning">
                                        <svg class="stroke-icon">
                                            <use href="images/icon-sprite.svg#hours-work"></use>
                                        </svg>
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3>40</h3>
                            ...
                            <table class="table display" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img src="images/1.png" alt=""></div>
                                                <div class="flex-grow-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img src="images/2_1.png" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6>Naomi watson</h6>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img src="images/3_1.png" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6>Dann Petty</h6>
                                                </div>
                            ...
                            <table class="table display table-bordernone" id="transaction" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img src="images/1_1.png" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img src="images/2.png" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <a href="product-page.html">
                                                        <h6>Spring Bed</h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img src="images/3.png" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <a href="product-page.html">
                                                        <h6>Long Dress</h6>
                                        ...
                                        <td class="text-end">
                                            <div class="btn bg-light-warning border-light-warning text-warning">Pending
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img src="images/4.png" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <a href="product-page.html">
                                        ...
                                        <td class="text-end">
                                            <div class="btn bg-light-danger border-light-danger text-danger">Canceled
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img src="images/5.png" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <a href="product-page.html">
                                                        <h6>Sofa Hauga</h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img src="images/6.png" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <a href="product-page.html">
                                                        <h6>Apple iMac 19”</h6>
                    ...
                    <div class="card-body audit-log">
                        <ul>
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-success"><img src="images/checked.png" alt="">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-warning"><img src="images/danger.png" alt="">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-danger"><img src="images/cancel.png" alt="">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                        ...
                        <ul>
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="images/icon-sprite.svg#box"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-warning border-light-warning">
                                    <svg class="stroke-icon stroke-warning">
                                        <use href="images/icon-sprite.svg#dolar"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                    <svg class="stroke-icon stroke-danger">
                                        <use href="images/icon-sprite.svg#round-right"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="images/icon-sprite.svg#pie-chart"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-warning border-light-warning">
                                    <svg class="stroke-icon stroke-warning">
                                        <use href="images/icon-sprite.svg#globe"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                    <svg class="stroke-icon stroke-none">
                                        <use href="images/icon-sprite.svg#box-user"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="images/icon-sprite.svg#work-bag"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="product-page.html">
                    ...
                    <div class="card-body top-user pt-2">
                        <ul>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="images/01.png" alt="">
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Alice Goodwin</h6>
                                        ...
                                        <p>
                                            <svg class="stroke-icon">
                                                <use href="images/icon-sprite.svg#map-icon"></use>
                                            </svg>Texas
                                        </p>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="images/02.png" alt="">
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Smith Lovell</h6>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="images/03.png" alt="">
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Jones Brooks</h6>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="images/04.png" alt="">
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Brown Acum</h6>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="images/05.png" alt="">
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Evans Mayo</h6>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="images/06.png" alt="">
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Wilson Pipes</h6>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="images/07.png" alt="">
                                    </div>
                                    <div>
                                        <a href="#">
                                            <h6>Alice Pindar</h6>
                    ...
                    <div class="card-body news-update">
                        <ul>
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="images/1_2.png"
                                        alt=""></div>
                                <div class="flex-grow-1">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="images/2_2.png"
                                        alt=""></div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="images/3_2.png"
                                        alt=""></div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="images/4_1.png"
                                        alt=""></div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="images/5_1.png"
                                        alt=""></div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                                        <h6>Business project research</h6>
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="images/6_1.png"
                                        alt=""></div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="images/7.png" alt="">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="private-chat.html">
                                        <h6>Added new work</h6>
                    ...
                    <div class="card-body total-invest">
                        <div class="row">
                            ...
                            <div class="col-6 col-md-12 invest-content text-center">
                                <svg class="stroke-icon">
                                    <use href="images/icon-sprite.svg#chart-invest"></use>
                                </svg>
            ...
            {{-- <div class="col-xxl-6 col-xl-7 proorder-xxl-5 col-md-6 box-col-6">
                <div class="card height-equal">
                    ...
                    <div class="card-body pt-0 manage-invoice filled-checkbox">
                        <div class="table-responsive theme-scrollbar">
                            <table class="table display table-bordernone mt-0" id="manage-invoice"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check checkbox checkbox-solid-primary">
                                                <input class="form-check-input" id="solid2" type="checkbox"
                                                    checked="">

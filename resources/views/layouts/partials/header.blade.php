<header class="page-header row">
    <div class="logo-wrapper d-flex align-items-center col-auto">
        <a style="margin-left:40px; width: 100px;" href="index.html"><img class="light-logo img-fluid"
                src="https://www.hajjisoft.com/public/uploads/business_logos/1740289852_WhatsApp%20Image%202025-02-23%20at%2011.48.55_5481131b.jpg"
                alt="logo"><img class="dark-logo img-fluid" src="images/logo-dark.png" alt="logo"></a>
            ...
            <ul class="header-right">
                ...
                <li class="custom-dropdown">
                    ...
                    <div class="custom-menu cart-dropdown py-0 overflow-hidden">
                        ...
                        <ul class="pb-0">
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="images/1_3.png"
                                        alt="">
                            ...
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="images/2_3.png"
                                        alt="">

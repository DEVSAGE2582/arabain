              ...
              <h6 class="lang-txt f-w-700">ENG</h6></a></div>
                ...
                <li class="search d-lg-none d-flex">
                    <a href="javascript:void(0)">
                        <svg>
            <use href="images/iconly-sprite.svg#Search"></use>
          </svg></a>
                </li>
                <li>
                    <a class="dark-mode" href="javascript:void(0)">
                        <svg>
            <use href="images/iconly-sprite.svg#moondark"></use>
          </svg></a>
                </li>
                <li class="custom-dropdown">
                    <a href="javascript:void(0)">
                        <svg>
            <use href="images/iconly-sprite.svg#cart-icon"></use>
                    ...
                    <div class="custom-menu cart-dropdown py-0 overflow-hidden">
                        ...
                        <ul class="pb-0">
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="images/1_3.png" alt="">
                        ...
                        <button class="btn quantity-right-plus" type="button" data-type="plus" data-field="">+</button></span>
                            ...
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="images/2_3.png" alt="">
                ...
                <li class="custom-dropdown">
                    <a href="javascript:void(0)">
                        <svg>
            <use href="images/iconly-sprite.svg#notification"></use>
                    ...
                    <svg class="circle-color">
                      <use href="images/iconly-sprite.svg#circle"></use>
                    </svg></span></h6>
                                    <h5>Alice Goodwin</h5>
                ...
                <li>
                    <a class="full-screen" href="javascript:void(0)">
                        <svg>
            <use href="images/iconly-sprite.svg#scanfull"></use>
          </svg></a>
                </li>
                <li class="custom-dropdown">
                    <a href="javascript:void(0)">
                      ...
                      <use href="images/iconly-sprite.svg#Search"></use>
                            ...
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 btn-activity-primary">
                                    <a href="index.html">
                                        <svg class="svg-color">
                                  <use href="images/iconly-sprite.svg#cube"></use>
                                </svg></a>
                                </div>
                                ...
                                <use href="images/iconly-sprite.svg#star"></use>
                              </svg>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 btn-activity-secondary">
                                    <a href="to-do.html">
                                        <svg class="svg-color">
                                  <use href="images/iconly-sprite.svg#check"></use>
                                </svg></a>
                                </div>
            ...
            <g class="climacon_iconWrap climacon_iconWrap-cloudDrizzle">
              ...
              <g class="climacon_wrapperComponent climacon_wrapperComponent-cloud">
                ...
                <li class="profile-nav custom-dropdown">
                    <div class="user-wrap" id="userDropdownToggle" style="cursor: pointer;">
                    ...
                    <div class="custom-menu overflow-hidden d-none" id="userDropdown">

                        <ul class="profile-body">
                            <li class="d-flex">
                                <svg class="svg-color"><use href="images/iconly-sprite.svg#Profile"></use></svg>
                                <a class="ms-2" href="user-profile.html">Account</a>
                            </li>
                            <li class="d-flex">
                                <svg class="svg-color"><use href="images/iconly-sprite.svg#Message"></use></svg>
                                <a class="ms-2" href="letter-box.html">Inbox</a>
                            </li>
                            <li class="d-flex">
                                <svg class="svg-color"><use href="images/iconly-sprite.svg#Document"></use></svg>
                                <a class="ms-2" href="to-do.html">Task</a>
                            </li>
                            <li class="d-flex">
                                <svg class="svg-color"><use href="images/iconly-sprite.svg#Login"></use></svg>

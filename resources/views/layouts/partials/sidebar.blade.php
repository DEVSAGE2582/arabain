        ...
        @if (!empty($userPermissions['users.show']) && Auth::user()->hasRole(2))
          ...
          <!--  <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Info-circle"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="file-manager.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Paper"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="kanban-board.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Wallet"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Bag"></use>
                    </svg>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li><a class="submenu-title" href="javascript:void(0)">Invoices<i class="iconly-Arrow-Right-2 icli">
                            </i></a>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Chat"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="bookmark.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Bookmark"></use>
                    </svg>
                    <h6 class="f-w-600">Bookmarks</h6>
                </a>
            </li>
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="contacts.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Contacts"></use>
                    </svg>
                    <h6 class="f-w-600">Contacts </h6>
                </a>
            </li>
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="task.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Tick-square"></use>
                    </svg>
                    <h6 class="f-w-600">Tasks</h6>
                </a>
            </li>
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="calendar-basic.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Calendar"></use>
                    </svg>
                    <h6 class="f-w-600">Calendar </h6>
                </a>
            </li>
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="social-app.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Camera"></use>
                    </svg>
                    <h6 class="f-w-600">Social App</h6>
                </a>
            </li>
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="to-do.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Edit"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="search.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Search-sidebar"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="buttons.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#More-box"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Folder"></use>
                    </svg>
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Ticket-star"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Activity"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Chart"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Filter"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Edit-line"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="landing-page.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Wallet"></use>
                    </svg>
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="sample-page.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Paper-plus"></use>
                    </svg>
                    <h6 class="f-w-600">Sample page</h6>
                </a>
            </li>
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="internationalization.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Play"></use>
                    </svg>
                    <h6 class="f-w-600">Internationalization</h6>
                </a>
            </li>
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="../starter-kit/index.html" target="_blank">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Star-kit"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Password"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Gallery"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Game"></use>
                    </svg>
            ...
            <li class="sidebar-list">
                <a class="sidebar-link" href="faq.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Danger"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Filter-2"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Work"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Discovery"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="javascript:void(0)">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Shield"></use>
                    </svg>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="knowledgebase.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Setting"></use>
                    </svg>
                    <h6 class="f-w-600">Knowledgebase</h6>
                </a>
            </li>
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i>
                <a class="sidebar-link" href="support-ticket.html">
                    <svg class="stroke-icon">
                        <use href="images/iconly-sprite.svg#Ticket"></use>
                    </svg>
